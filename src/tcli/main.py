...
KNOWN_COMMANDS = {"list", "update", "delete", "get", "add"}
...
def _create_todo(
    ...
    # Build TodoCreate, only including priority if it was explicitly provided
    todo_data = {
        "title": title,
    ...
    # Only add priority if it was explicitly provided (not None)
